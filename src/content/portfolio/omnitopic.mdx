...
1. Предложили два варианта общей логики фильтров. В первом есть страница со всеми фильтрами и возможны быстрые переходы на отдельные страницы фильтров для локаций и топиков. Во втором — фильтры для локаций и топиков, есть страница с дополнительными фильтрами.
