...
director: "Масштабное исследование, немедленно воплощенное в дизайне. Результаты прямо с колес шли в работу, детали пользовательского поведения сразу же отражались в общей концепции, каждый тип пользователей получил интерфейсные стимулы оставаться лояльным программе." 
