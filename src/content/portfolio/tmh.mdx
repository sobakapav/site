...
review: 
  text: |
    ...
    Мы провели множество воркшопов, включая интервью с медиками с нашей стороны и с найденными вами экспертами. Благодаря этому мы разработали интерфейс, который удовлетворяет как работающих в личном кабинете врачей, так и пользователей, передающих данные о своем состоянии и здоровье.
    
    Этот интерфейс объединяет ваш опыт дизайна медицинских интерфейсов, наш опыт создания и эксплуатации предыдущей версии интерфейса и обратную связь от пользователей. Это уникальный продукт не только для отечественного, но и для международного рынка, — редко встречаются настолько детально продуманные интерфейсы, приносящие такую пользу всем стейкхолдерам. Мы очень рады нашему сотрудничеству.
...
<em>Дашборд. <a href="/images/portfolio/tmh/1.jpg">Обычный</a>, <a href="/images/portfolio/tmh/1-2.jpg">right-to-left</a></em>
...
<em>Страница событий. <a href="/images/portfolio/tmh/9.jpg">Обычнная</a>, <a href="/images/portfolio/tmh/9-2.jpg">right-to-left</a></em>
...
<em>Страница пациента. <a href="/images/portfolio/tmh/2.jpg">Обычнная</a>, <a href="/images/portfolio/tmh/11.jpg">right-to-left</a></em>
