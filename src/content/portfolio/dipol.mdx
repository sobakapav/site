...
outcome:
  ...
  numbers:
    ...
    -
     title: Создали
     number: 3 темы
     text:  темную, светлую, а также дополнительный цвет по выбору заказчика. 
    -
...
Мы присоединились кмпроекту на стадии разработки продукта и некоторые части интерфейса разрабатывались «Собакой» с нуля. Для существующих элементов требовалось сохранить функциональность и расположение, чтобы пользователи внутри компании, работающие со старой версией интерфейса, могли быстро сориентироваться и в обновленном.
