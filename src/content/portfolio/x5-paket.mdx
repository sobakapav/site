...
Как промежуточный шаг построения единой CJM, мы [сделали по CJM для каждого из типов пользователей](https://miro.com/app/board/uXjVKef5v8Q=/?moveToWidget=3458764583063184408&cot=14). Нам нужно было увидеть, насколько схожи и насколько отличаются эти пути и сможем ли мы упаковать их в одну модель.
