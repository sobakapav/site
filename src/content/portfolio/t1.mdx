...
<div class="daisy-carousel w-full">
  <div id="slide29" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/29.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide31" class="btn btn-circle">❮</a>
      <a href="#slide30" class="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slide30" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/30.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide29" class="btn btn-circle">❮</a>
      <a href="#slide31" class="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slide31" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/31.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide30" class="btn btn-circle">❮</a>
      <a href="#slide29" class="btn btn-circle">❯</a>
...
<div class="daisy-carousel w-full">
  <div id="slide35" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/35.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide39" class="btn btn-circle">❮</a>
      <a href="#slide36" class="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slide36" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/36.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide35" class="btn btn-circle">❮</a>
      <a href="#slide37" class="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slide37" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/37.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide36" class="btn btn-circle">❮</a>
      <a href="#slide38" class="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slide38" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/38.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide37" class="btn btn-circle">❮</a>
      <a href="#slide39" class="btn btn-circle">❯</a>
  ...
  <div id="slide39" class="daisy-carousel-item relative w-full">
    <img
      src="/images/portfolio/t1/39.png"
      class="w-full" />
    <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slide38" class="btn btn-circle">❮</a>
      <a href="#slide35" class="btn btn-circle">❯</a>
...
<div class="daisy-diff aspect-[1280/700] diff-black">
  <div class="daisy-diff-item-1">
    <img alt="Собака Павлова • T1 • Внутренний медицинский стартап" 
...
<a href="/images/portfolio/t1/42.png" target="_blank">![Собака Павлова • T1 • Внутренний медицинский стартап](~/assets/images/portfolio/t1/25.png)</a>
<em>В четвертой итерации окончательно оформляется дизайн интерфейса</em>

<a href="/images/portfolio/t1/43.png" target="_blank">![Собака Павлова • T1 • Внутренний медицинский стартап](~/assets/images/portfolio/t1/25.png)</a>
