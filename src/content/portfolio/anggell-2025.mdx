...
context: |
  [Anggell](http://www.anggell.com/) — система поддержки принятия решений в ресторанном бизнесе. В основе лежит методология, разработанная владельцами известных петербургских ресторанов.
