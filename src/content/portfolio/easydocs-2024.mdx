...
Чтобы выяснить потребности пользователей, работающих в сфере найма, «Собака Павлова» провела исследование продуктов, которые предлагают похожий функционал. Отдельно мы пообщались со специалистами в области рекрутинга, узнали их требования к такого рода сервисам.
...
<a href="/images/portfolio/easydocs-2024/24.png" target="_blank">![Дизайн интерфейса модуля приема кандидатов на работу | SobakaPav.ru](~/assets/images/portfolio/easydocs-2024/24.png)</a>
