...
Заказчик получил обновленный интерфейс раздела “Предписания”, юзерфлоу взаимодействия пользователя с этим разделом по всем основным сценариям: создание предписания, отправка отчетов, оценка. 
