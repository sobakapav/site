...
context: |
  **Подробный кейс пока в работе. Если хотите посмотреть на этот дизайн в деталях, пишите нам на [we@sobakapav.ru](mailto:we@sobakapav.ru)**
  ...
  [Seatmap](https://seatmap.pro/) — профессиональный инструмент для создания планов рассадки различной сложности на стадионах, концертных площадках и аренах. ЦА сервиса — платформы онлайн-бронирования, билетные агенты и площадки для проведения различных массовых мероприятий.
isNew: true
logo:
...
## <a name="anchor3" />Визуальный язык

Заказчик подобрал наиболее репрезентативные площадки, для которых мы рисовали схемы. Театр, Рига арена и Barclays Center в Бруклине.
