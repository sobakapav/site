...
excerpt: Figmа для заказчикаВ стремлении научить всех владеть Figma на профессиональном уровне не забывайте о главных людях — тех, кто платят деньги, чтобы этого не уметь. Уже не раз менеджеры проектов со стороны заказчика просили нас провести какой-то ликбез или написать инструкцию, чтобы потом, когда наше участие в проекте закончится, они могли сами работать с дизайн-макетами.
author: Юлия Груздева
image: ~/assets/images/articles/cat.png
image-name: Ирина Кузнецова
image-alt: Figmа для заказчика
category: Практика
tags:
  - tag
  - tag-tag
  - taggy-tag
metadata:
  canonical: https://astrowind.vercel.app/article
---
