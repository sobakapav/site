...
metadata:
  ...
  title: Short guide to hiring normal people • Дизайн интерфейсов и бизнес
  description: Перевод статьи «Краткий гайд о том, как нанимать нормальных людей». Советуем прочесть, если вам нужно найти и нанять UX-дизайнера.
  robots:
    index: true
    follow: true
  openGraph:
